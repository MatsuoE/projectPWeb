...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/home" class="nav-link">
      <img src="/img/bandung.png" alt="Bandung Elektronika" class="brand-image elevation-3"
           style="opacity: .8">
<!--      <span class="brand-text font-weight-light">Bandung Elektronika</span> -->
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="/dashboardmember/profile/view" class="d-block">{{ auth()->user()->name }}</a>
        </div>
      </div>

      <!-- Sidebar Menu -->
      @include('layout.menudashboardmember')
      <!-- /.sidebar-menu -->
    </div>
    <!-- /.sidebar -->
  </aside>
